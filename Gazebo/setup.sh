mkdir -p ~/catkin_ws/src/quadcopter
cp -r * ~/catkin_ws/src/quadcopter
...
cd ~/catkin_ws/src/quadcopter/plugins
mkdir -p build
cd build
cmake ..
make
...
cd ~/catkin_ws/src/quadcopter/worlds/xacro
rosrun xacro xacro --inorder imav_indoor.world.xacro > ../imav_indoor.world 


echo 'export GAZEBO_PLUGIN_PATH=${GAZEBO_PLUGIN_PATH}:~/catkin_ws/src/quadcopter/plugins/build' >> ~/.bashrc
